...
You’ll find a dedicated assignment in the Teams menu where you can upload your file. Please name your file exactly as follows: `Lab-X_first-name_last-name.pdf` (e.g. `Lab-3_Ken_Tucky.pdf`). Please make sure your report is complete, concise (see indicated character limits) and submitted on time.
